...
namespace DataPowerTools.FastMember
{
    ...
    public abstract class TypeAccessor
    {
        ...
        private static readonly MethodInfo strinqEquals = typeof(string).GetMethod("op_Equality",
        ...
        private static TypeAccessor CreateNew(Type type, bool allowNonPublicAccessors)
        {
            ...
            if (!IsFullyPublic(type, props, allowNonPublicAccessors))
            {
                ...
                if (ctor != null)
                {
                    dynCtor = new DynamicMethod(type.FullName + "_ctor", typeof(object), TypeHelpers.EmptyTypes, type,
                        true);
            ...
            if (ctor != null)
            {
                ...
                body = tb.DefineMethod(baseMethod.Name, baseMethod.Attributes, baseMethod.ReturnType,
                    TypeHelpers.EmptyTypes);
                il = body.GetILGenerator();
            ...
            baseMethod =
                typeof(RuntimeTypeAccessor).GetProperty("Type", BindingFlags.NonPublic | BindingFlags.Instance)
                    .GetGetMethod(true);
