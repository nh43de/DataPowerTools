...
namespace DataPowerTools.FastMember
{
    internal static class CallSiteCache
    {
        ...
        internal static object GetValue(string name, object target)
        {
            ...
            {
                var newSite =
                    CallSite<Func<CallSite, object, object>>.Create(Binder.GetMember(CSharpBinderFlags.None, name,
                        typeof(CallSiteCache), new[] {CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)}));
                lock (getters)
                {
        ...
        internal static void SetValue(string name, object target, object value)
        {
            ...
            {
                var newSite =
                    CallSite<Func<CallSite, object, object, object>>.Create(Binder.SetMember(CSharpBinderFlags.None,
