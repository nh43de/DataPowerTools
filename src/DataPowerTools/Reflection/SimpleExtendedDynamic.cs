...
{
    public class SimpleExtendedDynamic : DynamicObject, INotifyPropertyChanged
    {
        readonly IDictionary<string, object> data;

        public SimpleExtendedDynamic()
        {
            this.data = new Dictionary<string, object>();
        }

        public SimpleExtendedDynamic(IDictionary<string, object> source)
        {
            this.data = source;
        }
